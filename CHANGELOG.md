...
- Updated the native iOS SDK version to 2.14.0

## [2.9.0] - 2026-09-16

- Added a `stopLoading` method to `KlarnaStandaloneWebView` to cancel an in-progress page load.
- Fixed the Klarna payment view on Android not updating its height when its content size changed.
- Updated the native Android SDK version to 2.14.1
...
- Updated the native iOS SDK version to 2.13.1
- Updated the native Android SDK version to 2.13.1
...
- Fixed iOS build failure for `KlarnaExpressCheckoutView` under both static library and `use_frameworks!` integrations.

## [2.5.3] - 2026-05-08

- Updated the native iOS SDK version to 2.11.6
- Updated the native Android SDK version to 2.11.3

## [2.5.2] - 2026-05-06

- Updated the native iOS SDK version to 2.11.5

## [2.5.1] - 2026-04-22

- Updated the native iOS SDK version to 2.11.3
- Updated the native Android SDK version to 2.11.2
...
- Updated the native Android SDK version to 2.8.1.
